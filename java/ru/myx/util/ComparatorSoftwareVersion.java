...
public class ComparatorSoftwareVersion implements Comparator<Object> {
	...
	final CharSequence s1 = o1 instanceof CharSequence ? (CharSequence) o1 : o1.toString();
	final CharSequence s2 = o2 instanceof CharSequence ? (CharSequence) o2 : o2.toString();
